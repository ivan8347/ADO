...
namespace Academy
{
    public partial class MainForm : Form
    {
        ...
        private void tabControl_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0: toolStripStatusLabel.Text = $"Количество студентов: {dgvStudents.RowCount - 1}"; break;
                case 1: toolStripStatusLabel.Text = $"Количество групп: {dgvGroups.RowCount - 1}"; break;
                case 2: toolStripStatusLabel.Text = $"Количество направлений обучения:{dgvDirections.RowCount - 1}"; break;

                case 3:
                    toolStripStatusLabel.Text = $"Количество дисциплин:{dgvDisciplines.RowCount - 1}"; break;


                case 4:
                    toolStripStatusLabel.Text = $"Количество преподователей:{dgvTeachers.RowCount - 1}"; break;
            }
        }
        /*private void tabControl_SelectedIndexChanged(object sender, EventArgs e)
        {
